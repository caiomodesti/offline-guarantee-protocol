    ...
    if (this.state.message !== null) {
      return React.createElement(SafeAreaView, { style: styles.safe },
        React.createElement(View, { style: styles.center },
          React.createElement(Text, { style: styles.title }, "Falha ao iniciar o pagador de demonstração"),
...
function Root() {
  return React.createElement(FatalErrorBoundary, null, React.createElement(DevelopmentApp));
}
